...
function getTargetFilepath(filepath, outputTemplate) {
    ...
    return outputTemplate.replace(/\[name\]/g, fileName);
}
...
class HandlebarsPlugin {
    ...
    constructor(options) {
        ...
        this.options.htmlWebpackPlugin = Object.assign({ enabled: false, prefix: "html" }, String(options.htmlWebpackPlugin) === "true" ? {enabled: true} : options.htmlWebpackPlugin);
